...
# https://github.com/nchie/valheim-desync-fix/blob/main/apply-valheim-lagfix.py

import os

file_path = "/home/steam/valheim/server/valheim_server_Data/Managed/assembly_valheim.dll"
